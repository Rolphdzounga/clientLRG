...
<Container >
  <div className='flex justify-center'>
    <Box className="bg-gray-50 min-w-96  flex items-center mt-10 w-1/2 justify-center">
      <div className="bg-gray-100 w-full flex flex-col rounded-2xl shadow-lg  p-5 items-center">
        
          <h2 className="font-bold text-2xl text-[#002D74]">Login</h2>
          <p className="text-xs mt-4 text-[#002D74]">If you are already a member, easily log in</p>
          <form action="" className="flex w-full justify-center items-center flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
            <input className="p-2 mt-8 rounded-xl w-4/5 border" type="email" {...register("email")} placeholder="Email"/>
            ...
            <button className="bg-[#002D74] rounded-xl w-4/5 text-white py-2 hover:scale-105 duration-300">Login</button>
          </form>
